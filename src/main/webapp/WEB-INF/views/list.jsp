...
<table align="center" border="1" onClick="window.open('${item.LINK}')" style="cursor:pointer; width: 500px">
    <tr>
        ...
        <td rowspan="2" style="border-bottom-right-radius: 10px; border-top-right-radius:10px"><button onclick="deleteLink('${item.ID}')">DEL</button></td>
    </tr>
    <tr>
...
<script>
    const deleteLink = (ID) => {
        location.href = "/member/delete?ID="+<I></I>D;
    }
</script>
</html>
